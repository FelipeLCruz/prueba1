...
<p>18. Realice un ejemplo con condicionales multiples</p>
    <form method="post">
      <label for="">Digite su edad por favor</label>
      ...
      if(isset($_POST['submit'])){
        $edad=$_POST['edad'];
        if($edad>0 && $edad<12){
          echo"esta persona es un niño";
        }elseif($edad>=12 && $edad<25){
          echo"esta persona es un adolocente";
        }elseif($edad>=25 && $edad<60){
          echo"Esta persona es un adulto";
        }elseif($edad>=60){
          echo"Esta persona es un adulto mayor";
        }
      }
