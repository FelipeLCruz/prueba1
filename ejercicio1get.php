...
<p>1. Lea la distancia inicial y final y los tiempos final e inicial para calcular la velocidad
de un objeto.
V=(DF-DI) / (TF-TI)</p>
    <form method="get">
    <label for="">Digite la distancia inicial</label>
    <input type="text" name="di"><br><br>
    <label for="">Digite la distancia final</label>
    <input type="text" name="df"><br><br>
    <label for="">Digite el tiempo inicial</label>
    <input type="text" name="ti"><br><br>
    <label for="">Digite el tiempo final</label>
    <input type="text" name="tf"><br><br>
    <input type="submit" value="calcular el tiempo" name="submit"><br><br></
    <?php
    if(isset($_GET['submit'])){
        $distanciainicial=($_GET['di']);
        $distanciafinal=($_GET['df']);
        $tiempoinicial=($_GET['ti']);
        $tiempofinal=($_GET['tf']);
        $velocidad=($distanciafinal-$distanciainicial)/($tiempofinal-$tiempoinicial);
        echo"la velocidad del objeto es: $velocidad";
    }
    ?>
    </form>
</body>
