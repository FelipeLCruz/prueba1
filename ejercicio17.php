...
<p>17. Cree un programa con variables para calcular el iva y el descuento de un producto</p>
    <form method="post">
      <label for="">ingrese el valor del producto</label><br>
      <input type="text" name="producto"><br>
      <label for="">ingrese el iva del producto</label>
      ...
      if(isset($_POST['submit'])){
        ...
        $ivapro=$producto*$iva/100;
        $valorproducto=$producto+$ivapro;
        $prodescu=$valorproducto*$descuento;
        $descuentot=$valorproducto-$prodescu;
        echo "el  valor del producto con su iva es: $valorproducto<br>";
        echo"el valor del producto con descuento es:$descuentot";
      }
      ?>
    </form>
</body>
