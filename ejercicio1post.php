...
<p>1. Escribir un algoritmo que, ingresada una calificación del 1 al 10, muestre por
pantalla los siguientes mensajes. Cuando la calificación sea de 7 o superior mostrar
“APROBADO” y si no obtuvo esa calificación mostrar “REPROBADO”</p>
<h1>Calcular la calificacion si es  aporbado o no aprobado de 1 a 10</h1>
<form method="post">
...
if ($calificacion>=7 && $calificacion<=10)
  echo "<br> Aprobo satisfactoriamente =)";
elseif ($calificacion<7 && $calificacion>=1)
echo "<br>Usted ha Reprobado;";
elseif ($calificacion>10){
  echo "<br> ingrese un un numero menor a 10";
}
}
?>
</form>
