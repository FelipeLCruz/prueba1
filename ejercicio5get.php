...
<p>5. Se requiere determinar el tiempo que tarda una persona en llegar de una ciudad
a otra en bicicleta, considerando que lleva una velocidad constante</p>
    <h1>Tiempo de Viaje en Bicicleta</h1>
    <form method="get">
        <label for="distancia">Digite la distancia entre las ciudades:</label>
        <input type="number" name="distancia"><br><br>
        <label for="velocidad">Digite la velocidad constante:</label>
        <input type="number"name="velocidad"><br><br>
        <input type="submit"value="Calcular Tiempo"name="submit"><br><br>
    </form>
    <?php
    if (isset($_GET['submit'])) {
        ...
        if ($velocidad > 0){
            ...
            echo"<h2>El tiempo estimado de viaje es: $tiempo horas</h2>";
        } else {
