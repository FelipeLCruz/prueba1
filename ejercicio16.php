...
<p>16. En un hogar el recibo del agua factura el metro cúbico en 2500, el servicio de aseo
en 30,000 y un cargo básico de 11000, elabore un programa que determine el valor
de la factura mensual a partir del consumo en metros.</p>
    <form method="post">
    <label for="">digite los metros consumidos:</label><br>
    ...
    if(isset($_POST['submit'])){
      $metros=$_POST['metros'];
      $valorfactura=($metros*$precio);
      $facturatotal=($valorfactura+$aseo+$cargobasico);
   
      echo"el valor total de la factura es: $facturatotal pesos ";
