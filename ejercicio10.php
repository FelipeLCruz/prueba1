...
<p>10. Dado un número del 1 al 7 indique a que día de la semana corresponde</p>
    <form  method="post">
      <label>Ingrese un numero del 1 al 7 para conocer el dia:</lAbel><br><br>
      <input type="text" name="dia"><br><br>
      <input type="submit" value="dia de la semana" name="submit"><br><br>
      <?php
    if(isset($_POST['submit'])){
      ...
      echo "El numero $dia corresponde al dia ".$semana[$dia];
