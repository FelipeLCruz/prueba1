...
<p>7. Dado un número entero positivo determine si es par o impar.</p>
    <form method="post">
        <label for="num">Digite un número positivo:</label><br>
        <input type="number" id="numero" name="num"><br><br>
