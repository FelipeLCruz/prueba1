...
<p>15. El consumo de combustible de un vehículo está diseñado para consumir un galón
por cada 80km, defina la distancia a recorrer en un viaje y determine la cantidad de
galones de gasolina que se requieren.</p>
    <form method="post">
    <label for="">digite los kilomentros que va a recorrer el vehiculo</label><br>
    <input type="text" name="recorrido"><br>
    <input type="submit"value="Calcular"name="submit"><br>
    <?php
    $distancia= 80;
    if(isset($_POST['submit'])){
      $recorrido=$_POST['recorrido'];
      $valortotaldegalones=($recorrido/$distancia);
   
      echo"el valor total de conbustible es: $valortotaldegalones galones ";
