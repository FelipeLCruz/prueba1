...
<p>4. Se requiere determinar la hipotenusa de un triángulo rectángulo. Recuerde que
por Pitágoras se tiene que: C2 = A2 + B2.</p>
    <h1>Hipotenusa de un Triángulo Rectángulo</h1>
    <form method="get">
        <label for="catetoA">Ingresa el Cateto A:</label>
        <input type="number" name="catetoA" ><br><br>

        <label for="catetoB">Ingresa el Cateto B:</label>
        <input type="number" name="catetoB"><br><br>

        <input type="submit" value="Calcular Hipotenusa" name="calcular">
    </form>
    <?php
    if (isset($_GET['calcular'])) {
        ...
        echo "<h2>La hipotenusa del triángulo rectángulo es: $hipotenusa</h2>";
    }
    ?>
</body>
</html>